...
STRATEGY_DESCRIPTIONS = {
    ...
    "均线多头缩量回踩MA5-保守": {
        "buy": "MA5 > MA10 > MA20；当天回踩MA5附近；收盘价站上MA5；成交量低于前5日均量；今日收盘价不低于昨日；BIAS20不超过10",
        "sell": "放量滞涨；或BIAS20大于10；或收盘价跌破MA10；或MA5下穿MA10",
        "scene": "上涨趋势中的稳健回踩低吸，尽量过滤弱反弹和追高。",
        "fit": "适合均线顺畅向上、成交活跃、趋势较稳但回踩幅度不大的强势股。",
        "avoid": "不太适合波动很大的题材股和经常深回踩的股票，可能因为过严而错过机会。",
        "risk": "买点更少，胜率可能更稳，但容易错过较快的反弹。",
    },
    "均线多头缩量回踩MA5-标准": {
        "buy": "MA5 > MA10 > MA20；当天回踩MA5附近；收盘价在MA5附近或上方；成交量低于或接近前5日均量；今日没有明显继续走弱；BIAS20不超过12",
        "sell": "放量滞涨；或BIAS20大于12；或收盘价跌破MA10；或MA5下穿MA10",
        "scene": "上涨趋势中的短线回踩低吸，平衡触发次数和信号质量。",
    ...
    "均线多头缩量回踩MA5-激进": {
        "buy": "MA5 > MA10 > MA20；当天回踩MA5附近；收盘价接近MA5即可；成交量允许略高于前5日均量；今日没有大幅继续走弱；BIAS20不超过15",
        "sell": "放量滞涨；或BIAS20大于15；或收盘价跌破MA20；或MA5下穿MA10",
        "scene": "强势股回踩后的更积极低吸，追求更多入场机会。",
        "fit": "适合弹性较强、经常快速回踩又快速修复的活跃趋势股。",
        "avoid": "不太适合趋势刚转弱、成交异常放大但价格走不动的股票。",
        "risk": "买入机会最多，但假回踩也更多，回撤可能大于保守和标准版本。",
    },
    "BIAS20超跌反弹-保守": {
...
STRATEGY_GROUPS = {
    "回踩类": ["均线多头缩量回踩MA5-保守", "均线多头缩量回踩MA5-标准", "均线多头缩量回踩MA5-激进"],
