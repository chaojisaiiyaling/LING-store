...
STRATEGY_DESCRIPTIONS = {
    ...
    "均线多头缩量回踩MA5-保守": {
        "buy": "MA5 > MA10 > MA20；最近2个交易日内回踩过MA5附近；收盘价站上MA5；成交量低于前5日均量；今日收盘价不低于昨日；BIAS20不超过10",
    ...
    "均线多头缩量回踩MA5-激进": {
        "buy": "MA5 > MA10 > MA20；最近5个交易日内回踩过MA5附近；收盘价接近MA5即可；成交量允许略高于前5日均量；今日没有大幅继续走弱；BIAS20不超过15",
